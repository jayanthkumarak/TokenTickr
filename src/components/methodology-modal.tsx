...
const METHODOLOGY_CONTENT = {
    ...
    'artificial-analysis': {
        ...
        description: "This score is derived from the MMLU-Pro benchmark, a rigorous test of reasoning and knowledge.",
        details: [
            "A more challenging version of the original MMLU benchmark",
            "Focuses on complex reasoning across diverse domains",
            "Higher ceiling separates frontier models more effectively",
            "Mapped to a 1000-1550 Elo scale for easy comparison",
        ],
        formula: null as string | null,
